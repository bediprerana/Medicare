...
//helper fiunction
//this function returns the date 22 jan 2026
...
//this function takes slot with date time and returns a dae object
...
const AppointmentPage = () => {
  ...
  //if the admin want to cancel appointments
          ...
          <div className={pageStyles.headerContainer}>
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <div className={pageStyles.filterContainer}>
                <div className={pageStyles.dateFilter}></div>
